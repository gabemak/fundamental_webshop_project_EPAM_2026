import{n as e,r as t,t as n}from"./main-DDy8OPbm.js";import{n as r,r as i}from"./main-D7MyJQla.js";var a=t((()=>{})),o=e((()=>{n(),a(),r();var e=JSON.parse(localStorage.getItem(`cart`)||`[]`);function t(){let t=document.getElementById(`cart-items-body`);if(t){if(e.length===0){t.innerHTML=`<tr><td colspan="6" style="text-align:center; padding: 20px;">Your cart is empty.</td></tr>`,o();return}t.innerHTML=e.map((e,t)=>`
        <tr class="cart-row">
