import{n as e,t}from"./main-YdjzZ70V.js";import{n}from"./header-Dt4JWo_7.js";var r=e((()=>{var e=document.getElementById(`contactForm`),t=document.getElementById(`email`),n=document.getElementById(`formResponse`);t&&t.addEventListener(`input`,()=>{/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t.value)?t.style.borderColor=`#b92770`:t.style.borderColor=`red`}),e&&n&&e.addEventListener(`submit`,t=>{t.preventDefault(),e.checkValidity()?(n.innerHTML=`
